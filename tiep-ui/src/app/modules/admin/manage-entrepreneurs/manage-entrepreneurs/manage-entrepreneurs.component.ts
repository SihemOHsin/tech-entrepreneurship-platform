...
export class ManageEntrepreneursComponent {
  items: any[] = [
    { userfirstname: 'Sihem', userlastname: 'Entrepreneur - Sihem Hsin', bizname: 'VirtuA Agency', dateOfBizCreation: '2020-01-06', industry: 'DIGITAL MARKETING', location: 'Sfax' },
